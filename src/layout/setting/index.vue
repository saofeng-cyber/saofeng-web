      ...
      <n-drawer-content title="系统设置">
        ...
        <div class="flex flex-wrap items-center gap-2 p-3">
          <div class="w-5 h-5 leading-5 text-center rounded-sm cursor-pointer"
            v-for="(item, index) in settingStore.appThemeList" :key="index" :style="{ 'background-color': item }"
            @click="toTheme(item)">
        ...
        <n-space justify="space-between" align="center" :item-style="{ padding: '12px 0' }">
          ...
          <n-input-number v-model:value="settingStore.sideWidth" placeholder="请输入" style="width: 120px" />
        </n-space>
        <template #footer>
